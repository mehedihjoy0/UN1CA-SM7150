...
LOG_STEP_IN "- Removing a52q specific blobs"

LOG_STEP_IN "- Removing init, soundbooster, audconf, lux"
...
LOG_STEP_IN "- Removing sensor config files"
...
LOG_STEP_IN "- Replacing a52q blobs with m51 specific"
git clone https://github.com/mehedihjoy0/M51-Device-Tree $MODPATH/tree
...
cp -r "$MODPATH/tree/system" "$TARGET_FIRMWARE_DEST/system"
cp -r "$MODPATH/avb" "$TARGET_FIRMWARE_DEST"
